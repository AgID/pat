{{--  Patrimonio Immobiliare index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Immobili presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/real-estate-asset/create')}}"
                                           title="Crea un nuovo immobile"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo immobile
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/real-estate-asset/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella immobili selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="real_estate_asset_list" class="table table-bordered table-striped table-hover">
...
{{ js('datatables-buttons/js/dataTables.buttons.min.js','common') }}

<script type="text/javascript">
    $(document).ready(function () {

        {{-- Begin Paginazione records datatable --}}
        let dtable = $("#real_estate_asset_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/real-estate-asset/list')}}",
            order: [
                [4, 'DESC'],
            ],
            columns: [
