{{--  Provvedimenti amministrativi index (Paginazione) --}}
<?php
/**
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Provvedimenti pubblicati</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/measure/create')}}"
                                           title="Crea un nuovo provvedimento"
                                           id="add-measure" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Provvedimento
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella provvedimenti selezionati"
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/measure/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Provvedimenti selezionati
                                        </a>
                                    </li>
                                @endif
            ...
            <div class="card-body">
                ...
                <table id="measures_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#measures_list").DataTable({
            ...
            bDeferRender: true,
            ajax: {
                url: "{{siteUrl('admin/measure/list')}}",
                type: "GET"
            },
            order: [
                [7, 'desc']
