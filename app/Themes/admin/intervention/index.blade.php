{{--  Interventi straordinari e di emergenza index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Interventi straordinari e di emergenza presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/intervention/create')}}"
                                           title="Crea un nuovo intervento"
                                           id="add-intervention" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Intervento
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella interventi selezionati"
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/intervention/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Interventi selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="interventions_list" class="table table-bordered table-striped table-hover" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <th>PROVVEDIMENTI CORRELATI</th>
                        <th>REGOLAMENTI</th>
                        <th>TERMINI TEMPORALI PER I PROVVEDIMENTI STRAORDINARI</th>
                        <th>COSTO INTERVENTI STIMATO</th>
                        <th>COSTO INTERVENTI EFFETTIVO</th>
                        <th>CREATO DA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#interventions_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/intervention/list')}}",
            order: [
                [8, 'desc']
            ],
            columns: [
