{{--  Procedimenti index (Paginazione) --}}
<?php
/**
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Procedimenti censiti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/proceeding/create')}}"
                                           title="Crea un nuovo procedimento"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Procedimento
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/proceeding/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Procedimenti selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                ...
                <table id="proceedings_list" class="table table-bordered table-striped table-hover">
                    <thead class="bg-table-accessibility">
                    <tr>
                        <th>
                            {{ form_checkbox('item[]', null, false, 'class="checkbox_all"') }}
                        </th>
                        <th>NOME DEL PROCEDIMENTO</th>
                        <th>UFFICI RESPONSABILI</th>
                        <th>RESPONSABILI PROCEDIMENTO</th>
                        <th>CREATO DA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#proceedings_list").DataTable({
            ...
            bDeferRender: true,
            ajax: {
                url: "{{siteUrl('admin/proceeding/list')}}",
                type: "GET",
            },
            order: [
                [5, 'DESC'],
