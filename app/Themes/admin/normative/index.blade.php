...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Normativa pubblicata</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/normative/create')}}"
                                           title="Crea una nuova norma"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi una nuova Norma
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/normative/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Norme selezionate
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="normatives_list" class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>NOME</th>
                        <th>STRUTTURE ORGANIZZATIVE DI RIFERIMENTO</th>
                        <th>LINK NORMA NORMATIVA</th>
                        <th>CREATO DA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#normatives_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/normative/list')}}",
            order: [
                [5, 'DESC'],
            ],
            columns: [
