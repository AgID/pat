{{--  Bandi di Concorso index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">{{ $archiveName }}</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/contest/create-contest')}}"
                                           title="Crea un nuovo bando"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Bando
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{siteUrl('admin/contest/create-alert')}}"
                                           title="Crea un nuovo avviso"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Avviso
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{siteUrl('admin/contest/create-result')}}"
                                           title="Crea un nuovo esito"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Esito
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella bandi selezionate"
                                           id="delete-items" class="dropdown-item" type="button"
                                           data-url="{{ siteUrl('admin/contest/deletes') }}">
            ...
            <div class="card-body">
                <table id="contests_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#contests_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/contest/list')}}",
            order: [
                [6, 'desc']
            ],
            columns: [
