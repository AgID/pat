...
<div class="row">
                    ...
                    <table class="table table-hover">
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo !empty($r['address']) ? escapeXss($r['address']) : 'N.D.' ?>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/real-estate-asset/edit/' . $r['id']); ?>">
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Patrimonio immobiliare"</strong>
        </div>
    <?php endif ?>
</div>
