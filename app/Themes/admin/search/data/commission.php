                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width:15%;">TOPOLOGIA</th>
                            <th style="width:20%;">PRESIDENTE O CAPOGRUPPO</th>
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo !empty($r['president']['full_name']) ? escapeXss($r['president']['full_name']) : 'N.D.' ?>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/commission/edit/' . $r['id']); ?>">
