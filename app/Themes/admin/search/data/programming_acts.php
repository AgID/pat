...
<div class="row">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width:10%;">PUBBLICA IN "OPERE PUBBLICHE"</th>
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            $programmingActDate = !empty($r['date'])
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $programmingActDate; ?>
                                </td>
                                <td>
                                    <?php echo !empty($r['public_in_public_works'] === 0) ? 'No' : 'Si'; ?>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/programming-act/edit/' . $r['id']); ?>">
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Atti di programmazione"</strong>
        </div>
    <?php endif ?>
</div>
