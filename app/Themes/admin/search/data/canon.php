...
<div class="row">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            if (!empty($r['properties']) && is_array($r['properties'])) {

                                $tmpResponsibles = System\Arr::pluck($r['properties'], 'name');
                            ...
                            <tr>
                                <td>
                                    <?php echo !empty($r['beneficiary']) ? escapeXss($r['beneficiary']) : 'N.D.' ?>
                                </td>
                                <td>
                                    <?php echo $responsibles ?>
                                </td>
                                <td>
                                    <?php echo !empty($r['amount']) ? '<small class="badge badge-success">' . $r['amount'] . ' &euro; </small>' : 'N.D.'; ?>
                                </td>
                                <td>
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Commissioni e gruppi consiliari"</strong>
        </div>
    <?php endif ?>
</div>
