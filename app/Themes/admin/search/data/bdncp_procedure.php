...
<div class="row">
            ...
            <div class="card">
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <th style="width:30%;">CIG</th>
                            <th style="width:15%;">OGGETTO</th>
                            <th style="width:20%;">LINK BANCA DATI NAZIONALE CONTRATTI PUBBLICI</th>
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            <tr>
                                <td>
                                    <?php echo !empty($r['cig']) ? escapeXss($r['cig']) : 'N.D.' ?>
                                </td>
                                <td>
                                    <?php echo !empty($r['object']) ? escapeXss($r['object']) : 'N.D.' ?>
                                </td>
                                <td>
                                    <?php echo !empty($r['bdncp_link']) ? escapeXss($r['bdncp_link']) : 'N.D.' ?>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/bdncp-procedure/edit/' . $r['id']); ?>">
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Procedure Banca Dati Nazionale Contratti Pubblici"</strong>
        </div>
    <?php endif ?>
</div>
