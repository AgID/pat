...
<div class="row">
            ...
            <div class="card">
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <th style="width:35%;">PROFILO ACL</th>
                            <th style="width:30%;">DESCRIZIONE</th>
                            <th style="width:30%;">ULTIMA MODIFICA</th>
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo !empty($r['description']) ? escapeXss(ucfirst($r['description'])) : 'N.D.' ?>
                                </td>
                                <td>
                                    <?php echo $updateAt; ?>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/acl-users-profile/edit/' . $r['id']); ?>">
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Profili ACL"</strong>
        </div>
    <?php endif ?>
</div>
