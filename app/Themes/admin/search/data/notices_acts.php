...
<div class="row">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width:10%;">PROCEDURA RELATIVA</th>
                        ...
                        foreach ($results['data'] as $r):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo !empty($r['relative_contest_act']['object']) ? escapeXss($r['relative_contest_act']['object']) : 'N.D.'; ?>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo siteUrl('admin/notices-act/edit/' . $r['id']); ?>">
    ...
    <?php else : ?>
        <div class="mt-2 col-lg-12 text-center">
            Nessun occorrenza trovata nella sezione <strong>"Atti delle amministrazioni"</strong>
        </div>
    <?php endif ?>
</div>
