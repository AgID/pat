{{--  Tassi di Assenza index (Paginazione) --}}
<?php
/**
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Tassi di assenza inseriti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                            <a href="{{siteUrl('admin/absence-rates/create')}}"
                                               title="Crea un nuovo personale"
                                               id="add-profiles" class="dropdown-item" type="button">
                                                <i class="fas fa-plus-circle mr-1"></i> Aggiungi nuovo Tasso di assenza
                                            </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/absence-rates/deletes') }}">
            ...
            <div class="card-body">
                ...
                <table id="absence_rates_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#absence_rates_list").DataTable({
            ...
            bDeferRender: true,
            ajax: {
                url: "{{siteUrl('admin/absence-rates/list')}}",
                type: "GET",
            },
            order: [
                [5, 'desc'],
