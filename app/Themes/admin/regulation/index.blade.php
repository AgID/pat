...
<div class="row">
    <div class="col-md-12">
        <div class="card">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/regulation/create')}}"
                                           title="Crea un nuovo documento"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Documento
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/regulation/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Documenti selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="regulations_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#regulations_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/regulation/list')}}",
            order: [
                [6, 'DESC'],
            ],
            columns: [
