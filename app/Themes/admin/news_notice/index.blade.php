{{--  News ed avvisi index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">News ed avvisi presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/news-notice/create')}}"
                                           title="Crea un nuovo avviso"
                                           id="add-news-notice" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi una nuova Notizia o Avviso
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella elementi selezionati"
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/news-notice/deletes') }}">
            ...
            <div class="card-body">
                <table id="news_list" class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>TITOLO</th>
                        <th>TIPOLOGIA</th>
                        <th>DATA VISUALIZZATA</th>
                        <th>SEZIONI DI PUBBLICAZIONE</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#news_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/news-notice/list')}}",
            order: [
                [3, 'desc']
            ],
            columns: [
