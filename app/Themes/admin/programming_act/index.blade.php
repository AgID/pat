{{--  Atti di programmazione index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Atti di programmazione presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/programming-act/create')}}"
                                           title="Crea un nuovo atto"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Atto
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella atti selezionati"
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/programming-act/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Atti selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="programming_acts_list" class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>OGGETTO</th>
                        <th>DATA</th>
                        <th>PUBBLICA IN "OPERE PUBBLICHE"</th>
                        <th>CREATO DA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#programming_acts_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/programming-act/list')}}",
            order: [
                [5, 'DESC']
            ],
            columns: [
