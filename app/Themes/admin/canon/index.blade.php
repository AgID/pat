{{-- Canoni di locazzione index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Canoni presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                   <li>
                                        <a href="{{siteUrl('admin/canon/create')}}"
                                           title="Crea un nuovo canone"
                                           id="add-profiles"
                                           class="dropdown-item"
                                           type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Canone
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/canon/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Canoni selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="canons_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#canons_list").DataTable({
