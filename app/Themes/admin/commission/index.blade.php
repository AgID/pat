{{--  Commissioni e gruppi consigliari index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Commissioni e gruppi consiliari inseriti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/commission/create')}}"
                                           title="Crea un nuovo elemento"
                                           id="add-commission" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi elemento
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/commission/deletes') }}">
            ...
            <div class="card-body">
                <table id="commissions_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#commissions_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/commission/list')}}",
            order: [
                [5, 'DESC'],
            ],
            columns: [
