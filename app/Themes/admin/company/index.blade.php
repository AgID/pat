{{--  Enti e società controllate index (Paginazione) --}}
<?php
/**
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Enti e società inserite</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/company/create')}}"
                                           title="Crea una nuova società"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi nuovo Ente o Società
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/company/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Enti e Società selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#company_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/company/list')}}",
            order: [
                [5, 'DESC'],
            ],
            columns: [
