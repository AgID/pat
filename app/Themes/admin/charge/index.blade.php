{{--  Oneri informativi e obblighi index (Paginazione) --}}
<?php
/**
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Oneri informativi e obblighi amministrativi pubblicati</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/charge/create')}}"
                                           title="Crea un nuovo onere"
                                           id="add-charge"
                                           class="dropdown-item"
                                           type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Onere o obbligo
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           title="Cancella oneri selezionati"
                                           id="delete-items" class="dropdown-item" type="button"
                                           data-url="{{ siteUrl('admin/charge/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Oneri e obblighi selezionati
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="charges_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#charges_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/charge/list')}}",
            order: [
                [6, 'desc']
            ],
            columns: [
