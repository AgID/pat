...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Personale inserito</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/personnel/create')}}"
                                           title="Crea un nuovo personale"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Aggiungi un nuovo Personale
                                        </a>
                                    </li>
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           id="delete-items" class="dropdown-item" type="button" data-url="{{ siteUrl('admin/personnel/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Personale selezionato
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                <table id="personnel_list" class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>NOME</th>
                        <th>RUOLO</th>
                        <th>INCARICO DI STAMPO POLITICO-ORGANO/I</th>
                        <th>REFERENTE PER LE STRUTTURE</th>
                        <th>CREATO DA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#personnel_list").DataTable({
            ...
            bServerSide: true,
            bDeferRender: true,
            ajax: "{{siteUrl('admin/personnel/list')}}",
            order: [
                [7, 'DESC']
            ],
            columns: [
