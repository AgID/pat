{{-- Incarichi e Consulenze index (Paginazione) --}}
<?php
/**
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Incarichi e consulenze presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/assignment/create-assignment')}}"
                                           title="Crea un nuovo incarico"
                                           id="add-profiles"
                                           class="dropdown-item"
                                           type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Nuovo Incarico
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{siteUrl('admin/assignment/create-liquidation')}}"
                                           title="Crea un nuovo liquidazione"
                                           id="add-profiles"
                                           class="dropdown-item"
                                           type="button">
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/assignment/deletes') }}">
            ...
            <div class="card-body">
                ...
                <table id="assignment_list" class="table table-bordered table-striped table-hover">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#assignment_list").DataTable({
            ...
            bDeferRender: true,
            ajax: {
                url: "{{siteUrl('admin/assignment/list')}}",
                type: "GET"
            },
            order: [
                [6, 'DESC']
