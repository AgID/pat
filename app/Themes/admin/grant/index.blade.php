{{--  Sovvenzioni e vantaggi economici index (Paginazione) --}}
<?php
/**
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <h3 class="card-title">Sovvenzioni presenti</h3>
                    </div>
                    ...
                    <div class="col-md-6 text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if(getAclAdd())
                                    <li>
                                        <a href="{{siteUrl('admin/grant/create-grant')}}"
                                           title="Crea un nuovo personale"
                                           id="add-profiles" class="dropdown-item" type="button">
                                            <i class="fas fa-plus-circle mr-1"></i> Nuova Sovvenzione
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{siteUrl('admin/grant/create-liquidation')}}"
                                           title="Crea un nuovo personale"
                                           id="add-profiles" class="dropdown-item" type="button">
                                ...
                                @if(getAclDelete())
                                    <li>
                                        <a href="#!"
                                           ...
                                           data-url="{{ siteUrl('admin/grant/deletes') }}">
                                            <i class="fas fa-trash mr-1"></i> Cancella Sovvenzioni selezionate
                                        </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="card-body">
                ...
                <table id="grants_list" class="table table-bordered table-striped table-hover">
                    <thead class="bg-table-accessibility">
                    <tr>
                        <th>
                            {{ form_checkbox('item[]', null, false, 'class="checkbox_all"') }}
                        </th>
                        <th>SOGGETTO BENEFICIARIO</th>
                        <th>OGGETTO</th>
                        <th>TIPOLOGIA</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dtable = $("#grants_list").DataTable({
