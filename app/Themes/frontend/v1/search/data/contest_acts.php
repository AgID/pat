...
<?php if (!empty($results['data'])) : ?>
    <div class="wrapper-risultati">
        ...
        foreach ($results['data'] as $item) :
            $link = siteUrl('page/581/details/' . $item['id'] . '/' . urlTitle($item['object'])); ?>
            <article>
                <div class="box-risultato">
                    <div>
                        <a class="categoria" href="<?php echo siteUrl('page/581/bandi-di-gara-e-contratti') ?>"><span
                                    class="fas fa-university"></span> Bandi Gare e Contratti</a>
                        <h3>
                            <a
