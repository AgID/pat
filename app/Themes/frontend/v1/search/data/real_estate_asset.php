...
<div class="wrapper-risultati">
    <?php
        foreach ($results['data'] as $item) :
            $link = siteUrl('page/133/details/' . $item['id'] . '/' . urlTitle($item['name'])); ?>
    <article>
        <div class="box-risultato">
            <div>
                <!-- Nome archivio -->
                <a class="categoria" href="<?php echo siteUrl('page/133/patrimonio-immobiliare') ?>"><span
                        class="fas fa-university"></span> Patrimonio immobiliare</a>
