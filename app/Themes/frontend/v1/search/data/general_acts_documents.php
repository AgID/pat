...
<?php if (!empty($results['data'])) : ?>
    <div class="wrapper-risultati">
        ...
        foreach ($results['data'] as $item) :
            $sectionId = !empty($item['public_in']) ? $item['public_in'][0]['section_fo_id'] : 580;
            $link = siteUrl('page/'.$sectionId.'/details/' . $item['id'] . '/' . urlTitle($item['object'])); ?>
            <article>
                <div class="box-risultato">
                    <div>
                        <a class="categoria" href="<?php echo siteUrl('page/'.$sectionId.'/atti-e-documenti-di-carattere-generale-riferiti-a-tutte-le-procedure') ?>"><span
                                class="fas fa-university"></span>Atti e Documenti di carattere generale</a>
                        <h3>
                            <a
