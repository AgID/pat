                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:150%;text-align:left;color:#000000;">
                                        ...
                                        <p>
                                            Per attivare il tuo account, &egrave; necessario accedere al link qui sotto,
                                            altrimenti non potrai utilizzare i tuoi dati
                                            per effettuare il login.
                                        </p>
                                        <p>
                                            Attivazione account: <br/>
                                            <?php echo $activationLink ?>
                                        </p>
                                        <p>
                                            Successivamente potrai accedere al Portale della trasparenza con i seguenti
                                            dati di accesso:
                                        </p>
                                        <p>
                                        <ul>
                                            <li>URL: <?php echo $url ?> </li>
                                            <li>Username: <?php echo $email ?> oppure <?php echo $username ?></li>
