            ...
            contents : [
                {
                    ...
                    elements :
                                ...
                                },
                                {
                                    ...
                                    children :
                                        [
                                        {
                                            ...
                                            {
                                                if ( !this.getValue() )
                                                    alert("Devi inserire l'URL per l'immagine");
                                                var tempUrl = this.getValue();
                                                if(tempUrl.indexOf('&larghezza') > 0) {
                                                	tempUrl = tempUrl.substring(0,tempUrl.indexOf('&larghezza'));
                                                }
                                                var tempLarghezza = this.getDialog().getValueOf( 'info', 'txtWidth' );
                                                this.setValue( tempUrl + '&larghezza=' + tempLarghezza);
                                        ...
                                        },
                                        {
                                            ...
                                            align : 'left',
                                            style : 'width:100%',
                                            label : editor.lang.image.archivioMultimedia,
                                            onClick : function()
                                            {
                                                var navigazione = window.open('./navigazione_immagini.php','immagini','height=600,width=520,toolbar=no,scrollbars=yes,status=yes');
                        ...
                        },
                        {
                            ...
                            {
                                if ( !this.getValue() )
                                    alert('ATTENZIONE: non puoi inserire una immagine nel contenuto, senza un testo alternativo. Inseriscilo e poi riprova.') ;
                                return !!this.getValue();
                            }
                        },
                        {
