...
CKEDITOR.dialog.add( 'link', function( editor )
{
    ...
    var showLinkInterno;
    if ( editor.config.toolbar == 'None' )
    	showLinkInterno = 'display:none;';
    else
    	showLinkInterno = '';
    ...
    return {
                    ...
                    },
                    {
                        ...
                        children :
                                ...
                                children :
                                    ...
                                    },
                                    {
                                        ...
                                        validate : function()
                                        {
                                            ...
                                            var tempRel = dialog.getValueOf('target','rel');
                                            var tempUrl = dialog.getValueOf('info','url');
                                            
                                            if(tempUrl.indexOf('&rel') > 0) {
                                            	tempUrl = tempUrl.substring(0,tempUrl.indexOf('&rel'));
                                            }
                                            if(tempRel == 'cbox_editor') {
                                            	dialog.setValueOf( 'info', 'url', tempUrl + '&rel=1' );
                                            	//dialog.getContentElement( 'info', 'url' ).setValue( tempUrl + '&rel=1');
                                            } else {
                                            	dialog.setValueOf( 'info', 'url', tempUrl);
                                            	//dialog.getContentElement( 'info', 'url' ).setValue( tempUrl);
                                            }
                            ...
                            },
                            {
                                type : 'button',
                                align : 'left',
                                style : 'width:100%;'+showLinkInterno,
                                label : editor.lang.common.linkInterno,
                                onClick : function()
                                {
                                    var navigazione = window.open('./link_interno.php','immagini','height=280,width=400,toolbar=no,scrollbars=no,status=no');
                        ...
                        children :
                            [
                            {
                                ...
                                'items' :
                                    ...
                                    [ editor.lang.link.targetPopup+' (non accessibile)', 'popup' ]
                                ],
                            ...
                            },
                            {
                                ...
                                'items' :
                                    [
                                    [ 'classica', '' ],
                                    [ 'colorbox', 'cbox_editor' ]
                                ],
                                setup : function( data )
                                {
                                    if ( data.target )
                                        this.setValue( data.target.rel );
                                },
                                commit : function( data )
                                {
                                    if ( !data.target )
        ...
        onOk : function()
        {
            ...
            if ( data.target )
            {
                ...
                if( data.target.rel == 'cbox_editor')
                {
                	attributes.rel = "cbox_editor";
                }
                else
                {
