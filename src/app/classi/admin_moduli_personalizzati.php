...
class moduliPersonalizzati {
	...
	function aggiungiModulo($arrayValori) {
		...
		list($giorno,$mese,$anno) = explode('/',$arrayValori['data_attivazione']);
		if (@checkdate($mese,$giorno,$anno)) {
			$arrayValori['data_attivazione'] = mktime(2,0,0,$mese,$giorno,$anno);
		} else {
			$arrayValori['data_attivazione'] = mktime();
		}
