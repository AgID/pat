...
$_POST['data_riesame'] = forzaStringa($_POST['data_riesame']);
$_POST['richiesta_riesame'] = forzaStringa($_POST['richiesta_riesame']);
?>

Richiesta di riesame per la richiesta di accesso civico effettuata da <?php echo $_POST['richiedente_ragsociale']; ?>.<br />
<br />
...
<br />
<strong>Richiesta di riesame</strong><br />
Data: <?php echo $_POST['data_riesame']; ?><br />
Richiesta di riesame: <?php echo nl2br($_POST['richiesta_riesame']); ?><br />
<br />
<br />
<br />
