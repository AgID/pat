...
$_POST['link'] = forzaStringa($_POST['link']);
...
Gentile <?php echo $_POST['richiedente_ragsociale']; ?>,<br />
la tua richiesta &egrave; stata correttamente inviata. Il codice della tua richiesta &egrave;<br />
<br />
...
if($_POST['link'] != '') {
	?>
	Pagina segnalata: <strong><?php echo $_POST['link']; ?></strong><br />
	<br />
	<?
}
?>
