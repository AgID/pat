...
if($output) {
	$record = array();
	$contenuto = str_replace('/./archiviofile','archiviofile',$contenuto);
	$contenuto = str_replace('/archiviofile','archiviofile',$contenuto);
	$contenuto = str_replace('src="archiviofile/','src="'.$server_url.'archiviofile/',$contenuto);
	$contenuto = str_replace('href="archiviofile/','href="'.$server_url.'archiviofile/',$contenuto);
